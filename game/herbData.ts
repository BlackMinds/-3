...
export interface HerbDef {
  ...
  isGiftIngredient?: boolean; // 2026-05-15: 礼物原料专用 — 收获不随机品质（统一 white），因为礼物 craft 与 quality 无关
}
...
export const HERBS: HerbDef[] = [
  ...
  // 情花系列（道侣礼物原料，design/system-companion.md 3.3.3）— 收获不随机品质，仅作为 craft 配方原料
  { id: 'silk_flower',      name: '相思藤', element: null, description: '凡/下品礼物原料',                          unlockPlotMaxLevel: 3,  isGiftIngredient: true },
  { id: 'butterfly_flower', name: '蝶恋花', element: null, description: '下/中品礼物原料',                          unlockPlotMaxLevel: 5,  isGiftIngredient: true },
  { id: 'moonlight_orchid', name: '月光兰', element: null, description: '中/上品礼物原料,种子需活动/红尘玉商店获取', unlockPlotMaxLevel: 7,  isGiftIngredient: true },
  { id: 'couple_lotus',     name: '并蒂莲', element: null, description: '上/极品礼物原料,种子需活动/红尘玉商店获取', unlockPlotMaxLevel: 10, isGiftIngredient: true },
  { id: 'lifelong_grass',   name: '长情草', element: null, description: '极品礼物必需原料,种子需活动/红尘玉商店获取', unlockPlotMaxLevel: 13, isGiftIngredient: true },
  { id: 'red_dust_flower',  name: '红尘花', element: null, description: '仙品礼物限定原料,种子仅七夕活动期间可得',   unlockPlotMaxLevel: 15, isGiftIngredient: true },
];

// 礼物原料判定（不参与品质随机机制）
export function isGiftIngredient(herbId: string): boolean {
  return !!getHerbById(herbId)?.isGiftIngredient;
}

// 灵草品质（种植时间不按品质分档；真实成熟时间由 server/api/cave/plant.post.ts 按灵田等级统一计算）
export const HERB_QUALITIES: HerbQualityDef[] = [
  { id: 'white',  name: '凡品', color: '#CCCCCC', multiplier: 1.00, baseYield: 9,  unlockPlotLevel: 1  },
  { id: 'green',  name: '灵品', color: '#00CC00', multiplier: 1.10, baseYield: 9,  unlockPlotLevel: 1  },
  { id: 'blue',   name: '玄品', color: '#0066FF', multiplier: 1.25, baseYield: 12, unlockPlotLevel: 4  },
  { id: 'purple', name: '地品', color: '#9933FF', multiplier: 1.50, baseYield: 12, unlockPlotLevel: 7  },
  { id: 'gold',   name: '天品', color: '#FFAA00', multiplier: 2.00, baseYield: 15, unlockPlotLevel: 10 },
  { id: 'red',    name: '仙品', color: '#FF3333', multiplier: 3.00, baseYield: 15, unlockPlotLevel: 13 },
];

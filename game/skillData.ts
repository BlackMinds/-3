...
export const DIVINE_SKILLS: Skill[] = [
  ...
  { id: 'mirror_water', name: '明镜止水', type: 'divine', rarity: 'purple', element: 'water', multiplier: 0, cdTurns: 9, description: '反弹24%伤害+8%最大气血 3回合(基础反弹≤6倍攻击力)', buff: { type: 'reflect', duration: 3, value: 0.24 } },
  // v3.6 DOT 流派紫色神通（3 条）

// 功法静态数据 - 完整版 (84 个功法：22 主修 + 32 神通 + 30 被动)
...
export const ACTIVE_SKILLS: Skill[] = [
  ...
  { id: 'frost_art', name: '玄冰诀', type: 'active', rarity: 'purple', element: 'water', multiplier: 1.50,
    description: '造成150%水属性伤害,25%冻结1回合;主修命中10%概率额外冻结1回合',
    debuff: { type: 'freeze', chance: 0.25, duration: 1 },
  ...
  { id: 'sky_inferno', name: '焚天烈焰诀', type: 'active', rarity: 'purple', element: 'fire', multiplier: 1.50,
    description: '造成150%火属性伤害,50%灼烧4回合;主修施加的灼烧每跳伤害+15%',
    debuff: { type: 'burn', chance: 0.50, duration: 4 },
...
export const DIVINE_SKILLS: Skill[] = [
  ...
  { id: 'frost_nova', name: '霜冻新星', type: 'divine', rarity: 'blue', element: 'water', multiplier: 0.85, cdTurns: 7, description: '[群攻] 全体85%伤害,40%冻结1回合', debuff: { type: 'freeze', chance: 0.40, duration: 1 }, isAoe: true },

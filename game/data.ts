...
export const MAPS: MapData[] = [
  ...
  // ===== T16 地图（道祖·初道）— power ×2 跨 T15；修为跨幅 ×1.2/tier（境界封顶避免溢出）=====
  {
    ...
    monsters: [
      { id: 'primal_warden', name: '洪荒守阙', power: 280000000, element: 'fire', exp: 460000000, spirit_stone_range: [2500000000, 6000000000], role: 'tank', drop_table: 'common_t16' },
      { id: 'primal_envoy', name: '初道使', power: 380000000, element: 'metal', exp: 600000000, spirit_stone_range: [3000000000, 7000000000], role: 'speed', drop_table: 'uncommon_t16' },
      { id: 'primal_dao_soul', name: '洪荒道魂', power: 460000000, element: null, exp: 840000000, spirit_stone_range: [7000000000, 15000000000], role: 'dps', drop_table: 'uncommon_t16' },
    ],
    boss: { id: 'primal_first_dao_lord', name: '洪荒初道祖', power: 1400000000, element: null, exp: 4200000000, spirit_stone_range: [50000000000, 110000000000], role: 'boss', drop_table: 'boss_t16' },
  },
  {
    ...
    monsters: [
      { id: 'celestial_dao_keeper', name: '天道守者', power: 320000000, element: 'earth', exp: 590000000, spirit_stone_range: [2500000000, 6000000000], role: 'tank', drop_table: 'common_t16' },
      { id: 'first_dao_general', name: '初道神将', power: 430000000, element: 'water', exp: 770000000, spirit_stone_range: [3000000000, 7000000000], role: 'dps', drop_table: 'uncommon_t16' },
      { id: 'dao_dawn_general', name: '道辰天将', power: 560000000, element: 'fire', exp: 1080000000, spirit_stone_range: [7000000000, 15000000000], role: 'dps', drop_table: 'uncommon_t16' },
    ],
    boss: { id: 'celestial_first_dao', name: '天道初辰', power: 1800000000, element: null, exp: 5400000000, spirit_stone_range: [70000000000, 150000000000], role: 'boss', drop_table: 'boss_t16' },
  },
  // ===== T17 地图（道祖·中道）— power ×1.7 跨 T16；修为续 ×1.2 =====
  {
    ...
    monsters: [
      { id: 'jundao_warden', name: '钧道守律', power: 600000000, element: 'wood', exp: 550000000, spirit_stone_range: [5000000000, 12000000000], role: 'tank', drop_table: 'common_t17' },
      { id: 'jundao_envoy', name: '钧道使', power: 800000000, element: 'metal', exp: 720000000, spirit_stone_range: [6000000000, 15000000000], role: 'speed', drop_table: 'uncommon_t17' },
      { id: 'jundao_supreme', name: '钧道天尊', power: 950000000, element: null, exp: 1010000000, spirit_stone_range: [15000000000, 35000000000], role: 'dps', drop_table: 'uncommon_t17' },
    ],
    boss: { id: 'hongjun_daojun', name: '鸿钧道君', power: 2400000000, element: null, exp: 5040000000, spirit_stone_range: [110000000000, 250000000000], role: 'boss', drop_table: 'boss_t17' },
  },
  {
    ...
    monsters: [
      { id: 'extreme_keeper', name: '天极守者', power: 700000000, element: 'earth', exp: 700000000, spirit_stone_range: [5000000000, 12000000000], role: 'tank', drop_table: 'common_t17' },
      { id: 'extreme_envoy', name: '极道使', power: 900000000, element: 'fire', exp: 925000000, spirit_stone_range: [6000000000, 15000000000], role: 'dps', drop_table: 'uncommon_t17' },
      { id: 'extreme_supreme', name: '天极天尊', power: 1150000000, element: 'water', exp: 1300000000, spirit_stone_range: [15000000000, 35000000000], role: 'dps', drop_table: 'uncommon_t17' },
    ],
    boss: { id: 'extreme_daozu', name: '天极道祖', power: 3000000000, element: null, exp: 6480000000, spirit_stone_range: [150000000000, 330000000000], role: 'boss', drop_table: 'boss_t17' },
  },
  // ===== T18 地图（道祖·末道）— power ×1.7 跨 T17；修为续 ×1.2 =====
  {
    ...
    monsters: [
      { id: 'wuji_warden', name: '无极守阙', power: 1200000000, element: 'earth', exp: 660000000, spirit_stone_range: [10000000000, 22000000000], role: 'tank', drop_table: 'common_t18' },
      { id: 'wuji_envoy', name: '无极道使', power: 1500000000, element: 'metal', exp: 865000000, spirit_stone_range: [12000000000, 28000000000], role: 'speed', drop_table: 'uncommon_t18' },
      { id: 'wuji_supreme', name: '无极天尊', power: 1800000000, element: null, exp: 1210000000, spirit_stone_range: [28000000000, 65000000000], role: 'dps', drop_table: 'uncommon_t18' },
    ],
    boss: { id: 'wuji_daozu', name: '无极道祖', power: 4500000000, element: null, exp: 6050000000, spirit_stone_range: [220000000000, 500000000000], role: 'boss', drop_table: 'boss_t18' },
  },
  {
    ...
    monsters: [
      { id: 'beyond_keeper', name: '混外守者', power: 1500000000, element: 'fire', exp: 845000000, spirit_stone_range: [10000000000, 22000000000], role: 'tank', drop_table: 'common_t18' },
      { id: 'ultimate_godhead', name: '终极道神', power: 2000000000, element: 'water', exp: 1110000000, spirit_stone_range: [12000000000, 28000000000], role: 'dps', drop_table: 'uncommon_t18' },
      { id: 'apocalypse_lord', name: '末劫之主', power: 2500000000, element: null, exp: 1555000000, spirit_stone_range: [28000000000, 65000000000], role: 'dps', drop_table: 'uncommon_t18' },
    ],
    boss: { id: 'beyond_chaos_lord', name: '混沌之外', power: 6000000000, element: null, exp: 7780000000, spirit_stone_range: [300000000000, 700000000000], role: 'boss', drop_table: 'boss_t18' },
  },

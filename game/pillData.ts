...
export const PILL_RECIPES: PillRecipe[] = [
  // ===== 初级战斗丹药(固定值, 自动解锁) =====
  {
    ...
    tierRequired: 1,
    successRate: 0.70,
    description: '攻击+20,持续5-8小时(品质系数放大固定值)',
    buffDuration: 10,
  ...
  // ===== 中级战斗丹药(低百分比, 金丹期解锁) =====
  {
    ...
    tierRequired: 3,
    successRate: 0.55,
    description: '攻击+6%,持续5-8小时(上限+40%)',
    buffDuration: 10,
  ...
  },
  {
    ...
    tierRequired: 3,
    successRate: 0.55,
    description: '防御+6%,持续5-8小时(上限+40%)',
    buffDuration: 10,
  ...
  },
  {
    ...
    tierRequired: 3,
    successRate: 0.55,
    description: '气血+8%,持续5-8小时(上限+40%)',
    buffDuration: 10,
  ...
  // ===== 高级战斗丹药(中等百分比, 需宗门商店解锁) =====
  {
    ...
    tierRequired: 5,
    successRate: 0.30,
    description: '攻击+10%,持续5-8小时(上限+40%,需宗门商店解锁)',
    buffDuration: 12,
  ...
  },
  {
    ...
    tierRequired: 5,
    successRate: 0.30,
    description: '防御+10%,持续5-8小时(上限+40%,需宗门商店解锁)',
    buffDuration: 12,
  ...
  },
  {
    ...
    tierRequired: 5,
    successRate: 0.30,
    description: '气血+12%,持续5-8小时(上限+40%,需宗门商店解锁)',
    buffDuration: 12,
  ...
  },
  {
    ...
    tierRequired: 6,
    successRate: 0.20,
    description: '攻击/防御/气血各+6%,持续5-8小时(需宗门商店解锁)',
    buffDuration: 15,

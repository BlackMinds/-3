...
export const DIVINE_SKILLS: Skill[] = [
  ...
  { id: 'mirror_water', name: '明镜止水', type: 'divine', rarity: 'purple', element: 'water', multiplier: 0, cdTurns: 9, description: '反弹40%伤害 3回合(单次反弹≤4倍攻击力)', buff: { type: 'reflect', duration: 3, value: 0.40 } },

export const OFFLINE_MAP_DATA: Record<string, { avgExp: number; avgStone: number; tier: number }> = {
  ...
  flame_core_cave:      { avgExp: 650,     avgStone: 200,      tier: 3 },
  ...
  karmic_flame_land:    { avgExp: 2900,    avgStone: 800,      tier: 4 },
  ...
  primordial_earth_ruins:{ avgExp: 13000,  avgStone: 5000,     tier: 5 },

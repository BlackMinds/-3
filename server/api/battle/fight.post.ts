...
export const ALL_MAPS: Record<string, { tier: number; monsters: MapMonster[]; boss: MapMonster | null }> = {
  ...
  celestial_mountain: { tier: 7, monsters: [
    { name: '仙鹤', power: 36000, element: 'metal', exp: 7200, stone_min: 3600, stone_max: 9600, role: 'balanced', drop_table: 'common_t7' },
    { name: '玉麒麟', power: 44000, element: 'earth', exp: 9000, stone_min: 6000, stone_max: 18000, role: 'dps', drop_table: 'uncommon_t7' },
    { name: '金龙', power: 56000, element: 'metal', exp: 11520, stone_min: 9600, stone_max: 30000, role: 'dps', drop_table: 'rare_t7' },
  ], boss: { name: '昆仑仙尊', power: 120000, element: 'metal', exp: 72000, stone_min: 60000, stone_max: 180000, role: 'boss', drop_table: 'boss_t7' } },
  nether_realm: { tier: 7, monsters: [
    { name: '冥卫', power: 50000, element: 'water', exp: 10080, stone_min: 3600, stone_max: 9600, role: 'balanced', drop_table: 'common_t7' },
    { name: '夺魂使', power: 60000, element: null, exp: 12600, stone_min: 6000, stone_max: 18000, role: 'dps', drop_table: 'uncommon_t7' },
    { name: '冥龙', power: 80000, element: 'water', exp: 16200, stone_min: 9600, stone_max: 30000, role: 'dps', drop_table: 'rare_t7' },
  ], boss: { name: '冥王', power: 180000, element: 'water', exp: 108000, stone_min: 60000, stone_max: 180000, role: 'boss', drop_table: 'boss_t7' } },
  immortal_realm: { tier: 8, monsters: [
    { name: '天兵', power: 80000, element: 'metal', exp: 19200, stone_min: 20000, stone_max: 50000, role: 'balanced', drop_table: 'common_t8' },
    { name: '神兽', power: 100000, element: null, exp: 24000, stone_min: 40000, stone_max: 100000, role: 'dps', drop_table: 'uncommon_t8' },
    { name: '远古神灵', power: 150000, element: null, exp: 36000, stone_min: 80000, stone_max: 200000, role: 'dps', drop_table: 'rare_t8' },
  ], boss: { name: '天帝', power: 300000, element: null, exp: 240000, stone_min: 200000, stone_max: 500000, role: 'boss', drop_table: 'boss_t8' } },
  chaos_origin: { tier: 8, monsters: [
    { name: '混沌兽', power: 180000, element: null, exp: 48000, stone_min: 20000, stone_max: 50000, role: 'balanced', drop_table: 'common_t8' },
    { name: '太古凶兽', power: 220000, element: null, exp: 60000, stone_min: 80000, stone_max: 200000, role: 'dps', drop_table: 'rare_t8' },
    { name: '道之幻影', power: 280000, element: null, exp: 76800, stone_min: 80000, stone_max: 200000, role: 'dps', drop_table: 'rare_t8' },
  ], boss: { name: '混沌之主', power: 500000, element: null, exp: 480000, stone_min: 200000, stone_max: 500000, role: 'boss', drop_table: 'boss_t8' } },
  void_holy_land: { tier: 9, monsters: [
    { name: '虚空剑侍', power: 240000, element: 'metal', exp: 120000, stone_min: 50000, stone_max: 120000, role: 'balanced', drop_table: 'common_t9' },
    { name: '圣境守护', power: 300000, element: 'earth', exp: 156000, stone_min: 50000, stone_max: 120000, role: 'tank', drop_table: 'common_t9' },
    { name: '天凤', power: 360000, element: 'fire', exp: 192000, stone_min: 100000, stone_max: 250000, role: 'dps', drop_table: 'uncommon_t9' },
  ], boss: { name: '太虚帝君', power: 600000, element: 'metal', exp: 960000, stone_min: 500000, stone_max: 1200000, role: 'boss', drop_table: 'boss_t9' } },
  hongmeng_realm: { tier: 9, monsters: [
    { name: '鸿蒙异兽', power: 280000, element: 'wood', exp: 144000, stone_min: 50000, stone_max: 120000, role: 'balanced', drop_table: 'common_t9' },
    { name: '本源精灵', power: 340000, element: 'water', exp: 180000, stone_min: 50000, stone_max: 120000, role: 'balanced', drop_table: 'common_t9' },
    { name: '始祖龙', power: 400000, element: null, exp: 216000, stone_min: 150000, stone_max: 300000, role: 'dps', drop_table: 'uncommon_t9' },
  ], boss: { name: '鸿蒙道尊', power: 720000, element: null, exp: 1200000, stone_min: 600000, stone_max: 1500000, role: 'boss', drop_table: 'boss_t9' } },
  myriad_battlefield: { tier: 9, monsters: [
    { name: '界域战士', power: 320000, element: 'fire', exp: 168000, stone_min: 60000, stone_max: 150000, role: 'balanced', drop_table: 'common_t9' },
    { name: '虚空刺客', power: 380000, element: null, exp: 204000, stone_min: 60000, stone_max: 150000, role: 'speed', drop_table: 'uncommon_t9' },
    { name: '远古泰坦', power: 480000, element: 'earth', exp: 240000, stone_min: 200000, stone_max: 400000, role: 'tank', drop_table: 'uncommon_t9' },
  ], boss: { name: '万界战神', power: 800000, element: null, exp: 1440000, stone_min: 800000, stone_max: 2000000, role: 'boss', drop_table: 'boss_t9' } },
  dao_trial: { tier: 10, monsters: [
    { name: '天道傀儡', power: 225000, element: null, exp: 360000, stone_min: 200000, stone_max: 500000, role: 'balanced', drop_table: 'common_t10' },
    { name: '规则执行者', power: 300000, element: null, exp: 480000, stone_min: 200000, stone_max: 500000, role: 'dps', drop_table: 'uncommon_t10' },
    { name: '命运织者', power: 375000, element: null, exp: 600000, stone_min: 500000, stone_max: 1000000, role: 'dps', drop_table: 'uncommon_t10' },
  ], boss: { name: '天道化身', power: 750000, element: null, exp: 2400000, stone_min: 2000000, stone_max: 5000000, role: 'boss', drop_table: 'boss_t10' } },
  eternal_peak: { tier: 10, monsters: [
    { name: '永恒守卫', power: 300000, element: 'metal', exp: 480000, stone_min: 300000, stone_max: 800000, role: 'balanced', drop_table: 'common_t10' },

...
const ALL_MAPS: Record<string, { tier: number; monsters: MapMonster[]; boss: MapMonster | null }> = {
  ...
  sunset_mountain: {
    tier: 2,
    monsters: [
      { name: '火狐妖', power: 640, element: 'fire', exp: 56, stone_min: 20, stone_max: 60, role: 'balanced', drop_table: 'common_t2' },
      { name: '熔岩蜥', power: 800, element: 'fire', exp: 70, stone_min: 20, stone_max: 60, role: 'balanced', drop_table: 'common_t2' },
      { name: '火鸦', power: 1200, element: 'fire', exp: 105, stone_min: 40, stone_max: 100, role: 'dps', drop_table: 'uncommon_t2' },
    ],
    boss: { name: '赤炎蟒', power: 2400, element: 'fire', exp: 1050, stone_min: 500, stone_max: 1000, role: 'boss', drop_table: 'boss_t2' },
  },
  jade_bamboo_forest: {
    tier: 2,
    monsters: [
      { name: '竹灵', power: 720, element: 'wood', exp: 63, stone_min: 20, stone_max: 60, role: 'balanced', drop_table: 'common_t2' },
      { name: '藤妖', power: 960, element: 'wood', exp: 84, stone_min: 20, stone_max: 60, role: 'balanced', drop_table: 'common_t2' },
      { name: '玉面猴', power: 1280, element: 'wood', exp: 112, stone_min: 40, stone_max: 100, role: 'dps', drop_table: 'uncommon_t2' },
    ],
    boss: { name: '千年竹妖', power: 2800, element: 'wood', exp: 1260, stone_min: 500, stone_max: 1000, role: 'boss', drop_table: 'boss_t2' },
  },
  iron_ore_cave: {
    tier: 2,
    monsters: [
      { name: '铁傀儡', power: 960, element: 'metal', exp: 77, stone_min: 20, stone_max: 60, role: 'balanced', drop_table: 'common_t2' },
      { name: '矿蝠', power: 1120, element: 'metal', exp: 91, stone_min: 20, stone_max: 60, role: 'balanced', drop_table: 'common_t2' },
      { name: '晶蚕', power: 1600, element: 'earth', exp: 126, stone_min: 40, stone_max: 100, role: 'dps', drop_table: 'uncommon_t2' },
    ],
    boss: { name: '矿灵王', power: 3200, element: 'metal', exp: 1400, stone_min: 500, stone_max: 1000, role: 'boss', drop_table: 'boss_t2' },
  },
  myriad_demon_mountain: { tier: 3, monsters: [
    { name: '树妖', power: 1200, element: 'wood', exp: 160, stone_min: 80, stone_max: 200, role: 'balanced', drop_table: 'common_t3' },
    { name: '熊妖', power: 1650, element: 'earth', exp: 220, stone_min: 80, stone_max: 200, role: 'balanced', drop_table: 'common_t3' },
    { name: '花妖', power: 2100, element: 'wood', exp: 280, stone_min: 150, stone_max: 400, role: 'dps', drop_table: 'uncommon_t3' },
  ], boss: { name: '妖猿王', power: 4500, element: 'earth', exp: 3200, stone_min: 2000, stone_max: 5000, role: 'boss', drop_table: 'boss_t3' } },
  thunderpeak: { tier: 3, monsters: [
    { name: '雷鹰', power: 1500, element: 'metal', exp: 200, stone_min: 80, stone_max: 200, role: 'balanced', drop_table: 'common_t3' },
    { name: '风暴狼', power: 1950, element: 'metal', exp: 260, stone_min: 80, stone_max: 200, role: 'balanced', drop_table: 'common_t3' },
    { name: '雷蛇', power: 2400, element: 'metal', exp: 320, stone_min: 150, stone_max: 400, role: 'dps', drop_table: 'uncommon_t3' },
  ], boss: { name: '雷鹏', power: 5400, element: 'metal', exp: 3600, stone_min: 2000, stone_max: 5000, role: 'boss', drop_table: 'boss_t3' } },
  ancient_ruins: { tier: 3, monsters: [
    { name: '石卫士', power: 1800, element: 'earth', exp: 240, stone_min: 80, stone_max: 200, role: 'balanced', drop_table: 'common_t3' },
    { name: '符傀儡', power: 2400, element: 'earth', exp: 320, stone_min: 150, stone_max: 400, role: 'dps', drop_table: 'uncommon_t3' },
    { name: '远古怨灵', power: 3000, element: null, exp: 400, stone_min: 150, stone_max: 400, role: 'dps', drop_table: 'uncommon_t3' },
  ], boss: { name: '遗迹守护者', power: 6600, element: 'earth', exp: 4800, stone_min: 2000, stone_max: 5000, role: 'boss', drop_table: 'boss_t3' } },
  dark_sea: { tier: 4, monsters: [
    { name: '海蛟', power: 4500, element: 'water', exp: 500, stone_min: 300, stone_max: 800, role: 'balanced', drop_table: 'common_t4' },
    { name: '幽灵鱼', power: 5500, element: 'water', exp: 625, stone_min: 300, stone_max: 800, role: 'balanced', drop_table: 'common_t4' },
    { name: '墨海兽', power: 7500, element: 'water', exp: 875, stone_min: 600, stone_max: 1500, role: 'dps', drop_table: 'uncommon_t4' },
  ], boss: { name: '龙龟', power: 15000, element: 'water', exp: 7500, stone_min: 8000, stone_max: 20000, role: 'boss', drop_table: 'boss_t4' } },
  soul_forest: { tier: 4, monsters: [
    { name: '噬魂树', power: 5000, element: 'wood', exp: 550, stone_min: 300, stone_max: 800, role: 'balanced', drop_table: 'common_t4' },
    { name: '幽影猫', power: 6250, element: null, exp: 700, stone_min: 300, stone_max: 800, role: 'balanced', drop_table: 'common_t4' },
    { name: '尸花', power: 8000, element: 'wood', exp: 950, stone_min: 600, stone_max: 1500, role: 'dps', drop_table: 'uncommon_t4' },
  ], boss: { name: '噬魂古树', power: 16250, element: 'wood', exp: 8750, stone_min: 8000, stone_max: 20000, role: 'boss', drop_table: 'boss_t4' } },
  desert_of_sands: { tier: 4, monsters: [
    { name: '沙蝎王', power: 6000, element: 'earth', exp: 650, stone_min: 300, stone_max: 800, role: 'balanced', drop_table: 'common_t4' },
    { name: '沙虫', power: 7500, element: 'earth', exp: 800, stone_min: 300, stone_max: 800, role: 'balanced', drop_table: 'common_t4' },
    { name: '蜃狐', power: 9500, element: 'fire', exp: 1050, stone_min: 600, stone_max: 1500, role: 'dps', drop_table: 'uncommon_t4' },
  ], boss: { name: '流沙帝蝎', power: 20000, element: 'earth', exp: 10000, stone_min: 8000, stone_max: 20000, role: 'boss', drop_table: 'boss_t4' } },
  purgatory: { tier: 5, monsters: [
    { name: '狱卒', power: 9000, element: 'fire', exp: 1500, stone_min: 1000, stone_max: 3000, role: 'balanced', drop_table: 'common_t5' },
    { name: '魔兵', power: 11000, element: 'metal', exp: 1800, stone_min: 2000, stone_max: 6000, role: 'dps', drop_table: 'uncommon_t5' },
    { name: '骨龙', power: 15000, element: 'fire', exp: 2700, stone_min: 5000, stone_max: 12000, role: 'dps', drop_table: 'rare_t5' },
  ], boss: { name: '炼狱魔君', power: 35000, element: 'fire', exp: 15000, stone_min: 30000, stone_max: 80000, role: 'boss', drop_table: 'boss_t5' } },
  frozen_abyss: { tier: 5, monsters: [
    { name: '霜巨人', power: 9500, element: 'water', exp: 1650, stone_min: 1000, stone_max: 3000, role: 'balanced', drop_table: 'common_t5' },
    { name: '冰魄', power: 12000, element: 'water', exp: 2100, stone_min: 2000, stone_max: 6000, role: 'dps', drop_table: 'uncommon_t5' },
    { name: '冰蛟龙', power: 16000, element: 'water', exp: 2850, stone_min: 5000, stone_max: 12000, role: 'dps', drop_table: 'rare_t5' },
  ], boss: { name: '寒渊冰帝', power: 38000, element: 'water', exp: 16500, stone_min: 30000, stone_max: 80000, role: 'boss', drop_table: 'boss_t5' } },
  demon_battlefield: { tier: 5, monsters: [
    { name: '魔将', power: 13000, element: 'fire', exp: 2250, stone_min: 2000, stone_max: 6000, role: 'dps', drop_table: 'uncommon_t5' },
    { name: '暗骑士', power: 16000, element: 'metal', exp: 2700, stone_min: 2000, stone_max: 6000, role: 'dps', drop_table: 'uncommon_t5' },
    { name: '战魔', power: 20000, element: null, exp: 3300, stone_min: 5000, stone_max: 12000, role: 'dps', drop_table: 'rare_t5' },
  ], boss: { name: '魔帅', power: 45000, element: null, exp: 22500, stone_min: 30000, stone_max: 80000, role: 'boss', drop_table: 'boss_t5' } },
  tribulation_wasteland: { tier: 6, monsters: [
    { name: '雷兽', power: 27000, element: 'metal', exp: 5000, stone_min: 5000, stone_max: 15000, role: 'balanced', drop_table: 'common_t6' },
    { name: '虚空生物', power: 33000, element: null, exp: 6500, stone_min: 8000, stone_max: 25000, role: 'speed', drop_table: 'uncommon_t6' },
    { name: '堕仙', power: 42000, element: 'metal', exp: 8500, stone_min: 15000, stone_max: 40000, role: 'dps', drop_table: 'rare_t6' },
  ], boss: { name: '雷帝', power: 90000, element: 'metal', exp: 50000, stone_min: 100000, stone_max: 300000, role: 'boss', drop_table: 'boss_t6' } },
  void_rift: { tier: 6, monsters: [
    { name: '虚空猎手', power: 28800, element: null, exp: 5500, stone_min: 5000, stone_max: 15000, role: 'balanced', drop_table: 'common_t6' },
    { name: '时光幻影', power: 34800, element: null, exp: 7000, stone_min: 8000, stone_max: 25000, role: 'speed', drop_table: 'uncommon_t6' },
    { name: '混沌元素', power: 45000, element: null, exp: 9000, stone_min: 15000, stone_max: 40000, role: 'dps', drop_table: 'rare_t6' },
  ], boss: { name: '虚空之主', power: 96000, element: null, exp: 55000, stone_min: 100000, stone_max: 300000, role: 'boss', drop_table: 'boss_t6' } },
  celestial_mountain: { tier: 7, monsters: [
    { name: '仙鹤', power: 36000, element: 'metal', exp: 16000, stone_min: 30000, stone_max: 80000, role: 'balanced', drop_table: 'common_t7' },
    { name: '玉麒麟', power: 44000, element: 'earth', exp: 20000, stone_min: 50000, stone_max: 150000, role: 'dps', drop_table: 'uncommon_t7' },
    { name: '金龙', power: 56000, element: 'metal', exp: 25600, stone_min: 80000, stone_max: 250000, role: 'dps', drop_table: 'rare_t7' },
  ], boss: { name: '昆仑仙尊', power: 120000, element: 'metal', exp: 160000, stone_min: 500000, stone_max: 1500000, role: 'boss', drop_table: 'boss_t7' } },
  nether_realm: { tier: 7, monsters: [
    { name: '冥卫', power: 50000, element: 'water', exp: 22400, stone_min: 30000, stone_max: 80000, role: 'balanced', drop_table: 'common_t7' },
    { name: '夺魂使', power: 60000, element: null, exp: 28000, stone_min: 50000, stone_max: 150000, role: 'dps', drop_table: 'uncommon_t7' },
    { name: '冥龙', power: 80000, element: 'water', exp: 36000, stone_min: 80000, stone_max: 250000, role: 'dps', drop_table: 'rare_t7' },
  ], boss: { name: '冥王', power: 180000, element: 'water', exp: 240000, stone_min: 500000, stone_max: 1500000, role: 'boss', drop_table: 'boss_t7' } },
  immortal_realm: { tier: 8, monsters: [
    { name: '天兵', power: 80000, element: 'metal', exp: 48000, stone_min: 200000, stone_max: 500000, role: 'balanced', drop_table: 'common_t8' },
    { name: '神兽', power: 100000, element: null, exp: 60000, stone_min: 400000, stone_max: 1000000, role: 'dps', drop_table: 'uncommon_t8' },
    { name: '远古神灵', power: 150000, element: null, exp: 90000, stone_min: 800000, stone_max: 2000000, role: 'dps', drop_table: 'rare_t8' },
  ], boss: { name: '天帝', power: 300000, element: null, exp: 600000, stone_min: 2000000, stone_max: 5000000, role: 'boss', drop_table: 'boss_t8' } },
  chaos_origin: { tier: 8, monsters: [
    { name: '混沌兽', power: 180000, element: null, exp: 120000, stone_min: 200000, stone_max: 500000, role: 'balanced', drop_table: 'common_t8' },
    { name: '太古凶兽', power: 220000, element: null, exp: 150000, stone_min: 800000, stone_max: 2000000, role: 'dps', drop_table: 'rare_t8' },
    { name: '道之幻影', power: 280000, element: null, exp: 192000, stone_min: 800000, stone_max: 2000000, role: 'dps', drop_table: 'rare_t8' },
  ], boss: { name: '混沌之主', power: 500000, element: null, exp: 1200000, stone_min: 2000000, stone_max: 5000000, role: 'boss', drop_table: 'boss_t8' } },
  void_holy_land: { tier: 9, monsters: [
    { name: '虚空剑侍', power: 240000, element: 'metal', exp: 300000, stone_min: 500000, stone_max: 1200000, role: 'balanced', drop_table: 'common_t9' },
    { name: '圣境守护', power: 300000, element: 'earth', exp: 390000, stone_min: 500000, stone_max: 1200000, role: 'tank', drop_table: 'common_t9' },
    { name: '天凤', power: 360000, element: 'fire', exp: 480000, stone_min: 1000000, stone_max: 2500000, role: 'dps', drop_table: 'uncommon_t9' },
  ], boss: { name: '太虚帝君', power: 600000, element: 'metal', exp: 2400000, stone_min: 5000000, stone_max: 12000000, role: 'boss', drop_table: 'boss_t9' } },
  hongmeng_realm: { tier: 9, monsters: [
    { name: '鸿蒙异兽', power: 280000, element: 'wood', exp: 360000, stone_min: 500000, stone_max: 1200000, role: 'balanced', drop_table: 'common_t9' },
    { name: '本源精灵', power: 340000, element: 'water', exp: 450000, stone_min: 500000, stone_max: 1200000, role: 'balanced', drop_table: 'common_t9' },
    { name: '始祖龙', power: 400000, element: null, exp: 540000, stone_min: 1500000, stone_max: 3000000, role: 'dps', drop_table: 'uncommon_t9' },
  ], boss: { name: '鸿蒙道尊', power: 720000, element: null, exp: 3000000, stone_min: 6000000, stone_max: 15000000, role: 'boss', drop_table: 'boss_t9' } },
  myriad_battlefield: { tier: 9, monsters: [
    { name: '界域战士', power: 320000, element: 'fire', exp: 420000, stone_min: 600000, stone_max: 1500000, role: 'balanced', drop_table: 'common_t9' },
    { name: '虚空刺客', power: 380000, element: null, exp: 510000, stone_min: 600000, stone_max: 1500000, role: 'speed', drop_table: 'uncommon_t9' },
    { name: '远古泰坦', power: 480000, element: 'earth', exp: 600000, stone_min: 2000000, stone_max: 4000000, role: 'tank', drop_table: 'uncommon_t9' },
  ], boss: { name: '万界战神', power: 800000, element: null, exp: 3600000, stone_min: 8000000, stone_max: 20000000, role: 'boss', drop_table: 'boss_t9' } },
  dao_trial: { tier: 10, monsters: [
    { name: '天道傀儡', power: 225000, element: null, exp: 900000, stone_min: 2000000, stone_max: 5000000, role: 'balanced', drop_table: 'common_t10' },
    { name: '规则执行者', power: 300000, element: null, exp: 1200000, stone_min: 2000000, stone_max: 5000000, role: 'dps', drop_table: 'uncommon_t10' },
    { name: '命运织者', power: 375000, element: null, exp: 1500000, stone_min: 5000000, stone_max: 10000000, role: 'dps', drop_table: 'uncommon_t10' },
  ], boss: { name: '天道化身', power: 750000, element: null, exp: 6000000, stone_min: 20000000, stone_max: 50000000, role: 'boss', drop_table: 'boss_t10' } },
  eternal_peak: { tier: 10, monsters: [
    { name: '永恒守卫', power: 300000, element: 'metal', exp: 1200000, stone_min: 3000000, stone_max: 8000000, role: 'balanced', drop_table: 'common_t10' },
    { name: '时间领主', power: 450000, element: 'water', exp: 1800000, stone_min: 3000000, stone_max: 8000000, role: 'dps', drop_table: 'uncommon_t10' },
    { name: '创世之灵', power: 600000, element: null, exp: 2400000, stone_min: 8000000, stone_max: 20000000, role: 'dps', drop_table: 'uncommon_t10' },
  ], boss: { name: '永恒之主', power: 1200000, element: null, exp: 12000000, stone_min: 50000000, stone_max: 100000000, role: 'boss', drop_table: 'boss_t10' } },
}

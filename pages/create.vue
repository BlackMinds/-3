...
const roots = [
  ...
  { id: 'fire', name: '火灵根', char: '火', color: '#c45c4a', glow: 'rgba(196,92,74,0.3)', desc: '烈焰焚天，攻血兼具', lore: '火主炽烈，气血与攻势同盛。修炼火系功法可灼烧敌人持续掉血，攻血兼修，烈焰长存。', tags: ['攻击+8%', '气血+7%', '火抗+15%'], stats: { hp: 535, atk: 54, def: 30, spd: 50 } },

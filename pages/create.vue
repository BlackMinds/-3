...
const roots = [
  ...
  { id: 'fire', name: '火灵根', char: '火', color: '#c45c4a', glow: 'rgba(196,92,74,0.3)', desc: '烈焰焚天，一击制敌', lore: '火主爆发，会心伤害极为恐怖。修炼火系功法可灼烧敌人持续掉血，瞬间爆发力冠绝五行。', tags: ['会伤+20%', '火抗+15%', '会心灼烧'], stats: { hp: 500, atk: 50, def: 30, spd: 50 } },

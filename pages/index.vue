          ...
          <div class="bag-with-preview">
            ...
            <aside class="bag-preview">
              <div v-if="hoverEquip" class="bag-preview-card">
                ...
                <div class="bag-preview-hint">点击格子 · 装备 / 强化 / 附灵 / 出售 · 右键锁定</div>
              </div>
        ...
        <div class="modal-body">
          ...
          <div class="help-section">
            ...
            <table class="help-table"><tbody>
              ...
              <tr><td><b>红尘玉</b></td><td>道侣游历红尘（筑基期后）/ 已结侣每日 +5</td></tr>
          ...
          <div class="help-section">
            ...
            <table class="help-table"><tbody>
              <tr><td>T1-T2</td><td>灵品主修(风刃/缠藤/寒冰/烈焰/裂地) + 灵品被动(金刚体/焚体诀/流水心法/盘根术/金身术)</td></tr>
              <tr><td>T3-T4</td><td>玄品主修(暴风刃/缠妖藤/寒霜诀/烈火诀/山岩击) + 玄品神通(天火术/霜冻新星/厚土盾/地裂波/万藤缚/金钟罩) + 玄品被动</td></tr>
              <tr><td>T5-T6</td><td>地品神通(含撼地裂石) + 地品被动(破绽感知/不动如山/百毒不侵/焚天之体/万毒归一/飘渺神行/春风化雨)</td></tr>
              <tr><td>T7+</td><td>天品神通(含寒髓裂魂/太极归一) + 天品被动(剑骨大成/木灵祝福/业火焚心等) + 仙品神通(万木归元/沧海归墟/焚天炼狱/开天辟地等) + 仙品被动(万剑朝宗/青木玄机/碧海无极/朱雀焚心/玄武天极等)</td></tr>
            </tbody></table>
            <p class="help-text" style="margin-top: 4px; color: #b87dff;">★ <b>地品五行主修</b>(罡风斩/万木枯荣诀/玄冰诀/焚天烈焰诀/撼山印)只在通天塔每 10 层节点掉落，详见下方「紫品主修残页」说明。</p>
            <p class="help-text" style="margin-top: 4px; color: var(--fade-ink);">⚠ <b>天品五行主修</b>(天罡剑诀/噬魂木/冰川大法/业火真诀/神山压) 与 <b>仙品至尊主修</b>(万象归元) 暂未开放掉落，后续版本接入。</p>
          ...
          <div class="help-section">
            ...
            <p class="help-text"><b style="color:#ff8cba">筑基期（境界 ≥ 2）</b>解锁。顶部 <b>🌹 红尘</b> 按钮进入。三大模块：<b>道侣花名册 / 游历红尘 / 子嗣</b>。所有产出与战斗系统隔离，单独走"游历"机制，避免高级图洗低级邂逅。首次游历必定触发道侣邂逅。</p>
          </div>
          <div class="help-section">
          ...
          <div class="help-section">
            ...
            <table class="help-table"><tbody>
              ...
              <tr><td>B 外出历练</td><td>退出助战，<b style="color:#5fcf6f">每天回家一次 +0.5% 永久全属性</b>，<b style="color:#ffd700">上限按资质</b>（凡14/下16/中18/上20/极21/仙21.5/<b>圣22%</b>），可随时召回</td></tr>
            </tbody></table>
        ...
        <div class="modal-body">
          ...
          <template v-if="pkTab === 'challenge'">
            <p class="pk-rules">
              ...
              ③ 仅主动挑战获胜才加积分（同境界 +20，跨境界加权）；输方扣分（同境界 -10），单日最多被扣 10 次（超出免扣）；被挑战防守胜利不加分
              ④ 每日 12:00 前 10 名邮件发奖
            </p>

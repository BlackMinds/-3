...
export const DIVINE_SKILLS: Skill[] = [
  // 玄品
  { id: 'fire_rain', name: '天火术', type: 'divine', rarity: 'blue', element: 'fire', multiplier: 3.0, cdTurns: 5, description: '造成300%伤害,20%灼烧3回合', debuff: { type: 'burn', chance: 0.20, duration: 3 } },
  { id: 'frost_nova', name: '霜冻新星', type: 'divine', rarity: 'blue', element: 'water', multiplier: 2.5, cdTurns: 6, description: '造成250%伤害,50%冻结2回合', debuff: { type: 'freeze', chance: 0.50, duration: 2 } },
  ...
  { id: 'vine_prison', name: '万藤缚', type: 'divine', rarity: 'blue', element: 'wood', multiplier: 1.5, cdTurns: 7, description: '造成150%伤害,50%束缚2回合', debuff: { type: 'root', chance: 0.50, duration: 2 } },
  ...
  { id: 'mirror_water', name: '明镜止水', type: 'divine', rarity: 'purple', element: 'water', multiplier: 0, cdTurns: 9, description: '反弹30%伤害 3回合,暴击率+20%', buff: { type: 'reflect', duration: 3, value: 0.30 } },
  // 天品
  ...
  { id: 'inferno_burst', name: '九天玄火阵', type: 'divine', rarity: 'gold', element: 'fire', multiplier: 5.5, cdTurns: 10, description: '造成550%伤害,50%灼烧4回合', debuff: { type: 'burn', chance: 0.50, duration: 4 } },
  // 仙品
  { id: 'time_stop', name: '时光凝滞', type: 'divine', rarity: 'red', element: null, multiplier: 0, cdTurns: 12, description: '必定冻结敌方2回合,自身攻击+50% 3回合', debuff: { type: 'freeze', chance: 1.0, duration: 2 }, buff: { type: 'atk_up', duration: 3, value: 0.50 } },
  { id: 'heavenly_wrath', name: '天罚雷劫', type: 'divine', rarity: 'red', element: 'metal', multiplier: 10.0, cdTurns: 12, description: '造成1000%伤害,40%眩晕1回合', debuff: { type: 'stun', chance: 0.40, duration: 1 } },
];
...
export const PASSIVE_SKILLS: Skill[] = [
  ...
  // 地品
  { id: 'crit_master', name: '破绽感知', type: 'passive', rarity: 'purple', element: 'metal', multiplier: 0, description: '暴击率+12%,暴击伤害+30%', effect: { CRIT_RATE_flat: 0.12, CRIT_DMG_flat: 0.30 } },
  ...
  { id: 'battle_frenzy', name: '战意沸腾', type: 'passive', rarity: 'gold', element: null, multiplier: 0, description: '每击杀+3%攻击,最多10层(换怪保留)', effect: { atk_per_kill_percent: 3, max_stacks: 10 } },

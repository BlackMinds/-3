...
.mountain-far {
  ...
  background: linear-gradient(
    180deg,
    transparent 0%,
    rgba(80, 75, 65, 0.20) 20%,
    rgba(80, 75, 65, 0.35) 100%
  );
  clip-path: polygon(
    0% 100%, 0% 65%, 8% 45%, 18% 55%, 28% 30%, 38% 50%,
    48% 20%, 58% 45%, 68% 25%, 78% 48%, 88% 35%, 95% 50%, 100% 40%, 100% 100%
  );
}
...
.mountain-mid {
  ...
  background: linear-gradient(
    180deg,
    transparent 0%,
    rgba(60, 55, 45, 0.25) 30%,
    rgba(60, 55, 45, 0.40) 100%
  );
  clip-path: polygon(
    0% 100%, 0% 70%, 12% 50%, 22% 65%, 35% 35%, 45% 55%,
    55% 30%, 65% 50%, 75% 40%, 85% 55%, 100% 45%, 100% 100%
  );
}
...
.mountain-near {
  ...
  background: linear-gradient(
    180deg,
    transparent 0%,
    rgba(45, 40, 32, 0.30) 40%,
    rgba(45, 40, 32, 0.50) 100%
  );
  clip-path: polygon(
    0% 100%, 0% 60%, 15% 40%, 30% 55%, 50% 30%,
    70% 50%, 85% 35%, 100% 50%, 100% 100%
  );
}
...
.cloud {
  ...
  background: radial-gradient(
    ellipse at center,
    rgba(200, 190, 170, 0.08) 0%,
    rgba(200, 190, 170, 0) 70%
  );
...
.mist-band {
  ...
  background: linear-gradient(
    90deg,
    transparent 0%,
    rgba(80, 75, 65, 0.12) 30%,
    rgba(80, 75, 65, 0.12) 70%,
    transparent 100%
  );
  animation: mist-float ease-in-out infinite;
}

.mist-1 {
  height: 60px; bottom: 25%;
  animation-duration: 12s;
}

.mist-2 {
  height: 40px; bottom: 35%;
...
@keyframes mist-float {
  ...
  50%      { opacity: 0.6; transform: translateX(3%); }
}
...
.particle {
  ...
  bottom: -10px;
  border-radius: 50%;
  background: radial-gradient(circle, rgba(125, 184, 142, 0.5) 0%, transparent 70%);
...
.login-card {
  ...
  background: linear-gradient(
    180deg,
    rgba(35, 32, 26, 0.85) 0%,
    rgba(28, 26, 20, 0.92) 100%
  );
...
.submit-btn {
  ...
  background: linear-gradient(
    135deg,
    rgba(107, 158, 125, 0.12) 0%,
    rgba(107, 158, 125, 0.06) 100%
  );
...
.btn-glow {
  ...
  background: linear-gradient(
    135deg,
    rgba(107, 158, 125, 0.15) 0%,
    rgba(107, 158, 125, 0.25) 50%,
    rgba(107, 158, 125, 0.15) 100%
  );
  opacity: 0;
...
.submit-btn:disabled:hover .btn-glow {
  opacity: 0;
}

...
> **🔄 v3.x 实装变更（以代码为准，本文未通改）：**
> - 节点数 **6 → 9**（新增 ⑦岚风=低品、⑧玄霜=中品、⑨紫电=上品；分布变 低×3/中×3/上×2/极×1）
> - **稀有掉落移除** — 上品 3% 丹方 / 极品 5% 觉醒石·附灵石 全部下线，节点只产出灵石+修为+贡献
> - 众矢之敌阈值 **占领 ≥4 → ≥6**（按比例 4/6 ≈ 6/9 上调）
> - 奖池综合贡献排行公式 `(1 - 占领数/6)` → `(1 - 占领数/9)`
> - 灵石数值已按 v3.7 -60% 减后值（低 800 / 中 2000 / 上 4800 / 极 10000），下表保留旧值仅供历史参考
...
|------|------|------|-------------------|---------|
| 1 | 青木灵脉 | 下品 | 灵石 +800 / 修为 +500 | 2 |
| 2 | 赤焰灵脉 | 下品 | 灵石 +800 / 修为 +500 | 2 |
| 3 | 玄水灵脉 | 中品 | 灵石 +2,000 / 修为 +1,200 | 3 |
| 4 | 黄土灵脉 | 中品 | 灵石 +2,000 / 修为 +1,200 | 3 |
| 5 | 白金灵脉 | 上品 | 灵石 +4,800 / 修为 +3,000 + **3% 概率解锁高级丹方** | 4 |
| 6 | 九天灵脉 | 极品 | 灵石 +10,000 / 修为 +6,000 + **5% 概率掉落觉醒石/附灵石** | 5 |

> v3.7 平衡：灵石奖励 -60%（原值 2,000 / 5,000 / 12,000 / 25,000），修为保持不变
...
| 宗门战期间暂停偷袭 | 周二 20:00 ~ 20:30 冻结偷袭（避免战报冲突） |
